...
namespace _3.Controller
{
    public class clsInfo
    {
        ...
        /// </summary>
        /// <returns>an clients info table</returns>
        ...
        public string ReaderAgency(string agencyName)
        {
            ...
            {
                MessageBox.Show("Error in the Controller select client by idclient : " + " " + ex.Message);
                return null;
            }
        }

        /// <summary>
        /// 8. Load employee name in the combo box employee -> call the info employee from data base and returns the info in a table
        /// </summary>
        /// <returns>an employee info table</returns>
